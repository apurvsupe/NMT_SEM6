...
def translate_sentence_eng_mr(sentence, encoder, decoder, helper):
...
def translate_sentence_eng(sentence, optimizer):
    # print("1\n")
    helper = Helper()
    ...
    translate_sentence_eng_mr("I", model1.encoder, model1.decoder, helper)
    model1.compile(optimizer=optimizer, loss="sparse_categorical_crossentropy", metrics=["accuracy"])
    model1.load_weights(weight_path)

    sent = translate_sentence_eng_mr(sentence, model1.encoder, model1.decoder, helper)
    return sent
